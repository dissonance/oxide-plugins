...
namespace Oxide.Plugins {
    [Info("Simple Clans", "by playrust.io / dcode and modified by dissonance", "1.0.0")]
    ...
    public class SimpleClans : RustPlugin
    {
        ...
        {
            clans.Clear();
            var data = Interface.Oxide.DataFileSystem.GetDatafile("simple_clans");
            if (data["clans"] != null) {
        ...
        private void saveData()
        {
            ...
            Interface.Oxide.DataFileSystem.SaveDatafile("simple_clans");
        }
        ...
        private void ClanCommand(BasePlayer player, string command, string[] args)
        {
            ...
            if (args.Length == 0) {
                sb.Append("<size=22>Simple Clans</size> " + Version + "\n");
                if (myClan == null) {
